const messages = [
    ...
    { text: "Chúc chị tuổi mới sẽ đạt được mọi ước mơ, luôn an yên và ngập tràn hạnh phúc. Mong rằng những điều tốt đẹp nhất sẽ đến với chị trong năm nay và mãi mãi về sau. Sinh nhật vui vẻ, chị nhé! 🥳", bg: "Picture/pic4.png"}
];
